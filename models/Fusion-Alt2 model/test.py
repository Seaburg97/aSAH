...
def predict_mrs_outcome(model_path, age, hunt_hess_score, mfs_score, sebes_score, prediction_post):
    """
    ...
    Args:
        ...
        prediction_post: Post-operative prediction value (0-6 range)
    ...
    # Extracted standardization parameters for Prediction_post
    PREDICTION_POST_MEAN = 1.8524078353
    PREDICTION_POST_STD = 1.6582795724
    ...
    # Step 5: Add the additional feature (Prediction_post)
    # This feature was added separately and needs manual standardization
    prediction_post_scaled = (prediction_post - PREDICTION_POST_MEAN) / PREDICTION_POST_STD
    final_features.append(prediction_post_scaled)
...
if __name__ == "__main__":
    ...
    print("  Prediction_post Mean: 1.8524078353")
    print("  Prediction_post Std:  1.6582795724")
    
    model_path = 'Fusion-Alt2_model.pkl'
    ...
    result = predict_mrs_outcome(
        ...
        prediction_post=2.94           # Post-operative prediction
    )
    ...
    print(f"🔧 Usage:")
    print(f"   result = predict_mrs_outcome(model_path, age, hunt_hess, mfs, sebes, prediction_post)")
    ...
    for age, hunt_hess, mfs, sebes, prediction_post in test_cases:
        result = predict_mrs_outcome(model_path, age, hunt_hess, mfs, sebes, prediction_post)
        print(f"   Age {age}, H-H {hunt_hess}, mFS {mfs}, SEBES {sebes}, Pred_post {prediction_post} → mRS: {result['mRS_prediction']}")